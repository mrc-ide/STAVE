...
This table stores the genetic information. An example of a correctly formatted *Counts* table is given below:
...
rbind.data.frame(list(Column = cell_spec("study_id", color = "white", background = "#0366d6"),
                 ...
                 list(Column = cell_spec("variant_string", color = "white", background = "#0366d6"),
                      ...
                      Notes = "A single- or multi-locus haplotype (see below)."),
                 ...
                 list(Column = "notes",
                      ...
                      Notes = "Any further information about this mutation (free text).")) |>
...
The *variantstring* format is defined in the [*variantstring*](https://github.com/mrc-ide/variantstring) package - refer to that package documentation for details. The current version of STAVE uses *variantstring* v1.8.6.

---

The [next page](articles/howto_encoding.html) demonstrates some of the nuances of encoding genetic data.
