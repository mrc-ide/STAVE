...
Prevalence calculation in STAVE starts by specifying the variant of interest in [variantstring](https://github.com/mrc-ide/variantstring) format. For example:
