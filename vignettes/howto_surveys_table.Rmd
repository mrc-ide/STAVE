...
rbind.data.frame(list(Column = cell_spec("study_id", color = "white", background = "#0366d6"),
                 ...
                 list(Column = cell_spec("sample_source", color = "white", background = "#0366d6"),
                       Type = "Character string. One of a pre-defined set of levels.",
                       Notes = paste0(
                         "The sampling context from which samples were obtained.",
                         "<ul style='margin:4px 0; padding-left:1.2em;'>",
                         "<li><code>clinical_passive</code> — symptomatic patients self-presenting to a health facility</li>",
                         "<li><code>clinical_anc</code> — pregnant women screened at antenatal care</li>",
                         "<li><code>clinical_tes</code> — WHO therapeutic efficacy study</li>",
                         "<li><code>clinical_trial</code> — other formal clinical trial or RCT</li>",
                         "<li><code>community_household</code> — cross-sectional survey of residents at home or in the community</li>",
                         "<li><code>community_school</code> — school-based survey of children</li>",
                         "<li><code>cohort</code> — longitudinal follow-up of a defined enrolled cohort</li>",
                         "<li><code>other</code> —any other context not listed</li>",
                         "<li><code>unknown</code> — sampling context not recorded or cannot be determined from the source</li>",
                         "</ul>"
                       )),
...
The [next page](articles/howto_counts_table.html) shows how to encode genetic data in the *Counts* table.
